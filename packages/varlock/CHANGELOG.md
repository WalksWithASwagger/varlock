...
-  *(minor)* - Add generateOtp() for generating TOTP 2FA codes
-  *(minor)* - proxy: `--persist-ca` keeps a broker's CA across restarts so clients that already trust it keep working
-  *(minor)*
